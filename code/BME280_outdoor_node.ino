...
//上传
#define BC26_ALI_SENSOR_UPLOAD "AT+QMTPUB=0,12,1,0,\"/sys/%s/%s/thing/event/property/post\",\"{'id':'110','version':'1.0','method':'thing.event.property.post','params':{'temp':%d,'pres':%d,'humi':%d}}\"\r\n"


//三元组
#define ProductKey "gh7xDQYxrG9"
#define DeviceName "BME280_Outside"
#define DeviceSecret "6b8ea69e937852f04c95e8902992424e"
...
bool BC26_sensor_upload(int temp,int pres,int humi);
...
void loop()
{
  while (1)
  {
    ...
    getPres();
    getHumi();
    BC26_sensor_upload(temp,pres,humi); 
